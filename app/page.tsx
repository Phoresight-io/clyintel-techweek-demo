    ...
    <div style={{ background: C.bg, minHeight: '100vh', fontFamily: "'DM Sans', sans-serif", color: C.text }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div className="hs" style={{ display: 'flex', gap: 2, overflowX: 'auto', marginLeft: 12, alignItems: 'center' }}>
            <a
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#0A66C2" aria-label="LinkedIn">
